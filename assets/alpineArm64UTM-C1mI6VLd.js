...
- **GitHub 搜索 \`sway dotfiles\`**：[快速跳转](https://github.com/search?q=sway+dotfiles)——数千份公开配置可直接借鉴
...
另外一说，如果你选择了 zsh，[Oh My Zsh](https://ohmyz.sh/) 也是高质量配置起点，安装后可从数千款主题和插件中选择。具体配置注意事项见下方 FAQ“如何更换 Shell？”。
